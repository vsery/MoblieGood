...
<template>
    <div id="orderList">
        ...
        <!-- <mt-tab-container-item id="tab-all"> -->
            ...
            <!-- <mt-tab-container-item id="tab-received"></mt-tab-container-item>
            <mt-tab-container-item id="tab-paying"></mt-tab-container-item>
            <mt-tab-container-item id="tab-appraise"></mt-tab-container-item>
            <mt-tab-container-item id="tab-complete"></mt-tab-container-item>
            <mt-tab-container-item id="tab-return"></mt-tab-container-item> -->
        </mt-tab-container>
    </div>
</template>
<script>
...
#orderList .mint-navbar .mint-tab-item.is-selected { border-color: #ff4242; }
...
#orderList .order-item .order-title .shop i.icon { color: #b5b4b7; font-size: 2rem; margin-right: .5rem; vertical-align: middle; }
#orderList .order-item .order-title .shop span.name { color: #b5b4b7; color: #333333; font-size: 1.19rem; }
...
#orderList .order-item .order-info .order-describe .order-help { margin-top: 1rem; height: 1.67rem; }
#orderList .order-item .order-info .order-describe .order-help span.key { vertical-align: middle; font-size: .9rem; color: #ff9000; border: 1px double #ff9000; padding: .35rem .25rem .15rem .25rem; margin-right: .5rem; }
...
#orderList .order-item .order-info .order-price-box .order-price-old { width: 100%; text-align: right; color: #999999; font-size: 1.2rem; line-height: 1.4rem; }
...
#orderList .order-item .order-system a.order.button { font-size: 1.19rem; display: inline-block; height: 2.5rem; line-height: 2.5rem; border: .1px double #939393; padding: 0 1rem; border-radius: .25rem; font-weight: 100; }
...
/*#orderList .order-item .order-system { display: block; height: 5rem; padding: 1.25rem 0; }*/
</style>